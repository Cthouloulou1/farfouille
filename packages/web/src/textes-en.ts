...
export const EN: Readonly<Record<string, string>> = {
  ...
  "Grands formats": "Large racks",
  "Formats courants": "Common racks",
  "De 10 sur 10 à 15 sur 15": "From 10 of 10 to 15 of 15",
  "De la partie normale au 7, 8 et 9": "From the standard game to 7, 8 and 9",

  "Joueurs": "Players",
  "Solo": "Solo",
  "Tableaux annexes": "Side tables",
  "Mots": "Words",
  ...
  "Chrono le plus serré": "Tightest clock",
  ...
  "{n} partie au tableau": "{n} game listed",
  "{n} parties au tableau": "{n} games listed",
  "{n} coup au tableau": "{n} move listed",
  "{n} coups au tableau": "{n} moves listed",
  "{n} mot au tableau": "{n} word listed",
  "{n} mots au tableau": "{n} words listed",
  "serveur injoignable": "server unreachable",
  ...
  "Un nombre conséquent de lettres": "A great many letters",
  "Classer par": "Sort by",
  "Temps de la partie": "Game time",
  ...
  "{n} coup joué": "{n} move played",
  "{n} coups joués": "{n} moves played",
};
