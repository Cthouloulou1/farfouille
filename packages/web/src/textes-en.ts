...
export const EN: Readonly<Record<string, string>> = {
  ...
  "Topping": "Topping",
  "Duplicate": "Duplicate",
  "Double joker": "Double blank",
  "Deux jokers à chaque tirage, au lieu d'un": "Two blanks in every rack instead of one",
  ...
  // ------------------------------------------------------------ les records
  // « Farfouille » ne se traduit pas : c'est le nom du coup, et du site.
  // « Top » et « topée » restent tels quels -- le vocabulaire du jeu est le
  // meme dans les deux langues.
  "Partie normale": "Standard game",
  "Partie normale solo": "Standard game, solo",
  "Montante": "Ladder",
  "7 sur 8 joker": "7 of 8, blank",
  "7 et 8 joker": "7 and 8, blank",
  "7, 8 et 9": "7, 8 and 9",
  "7, 8 et 9 joker": "7, 8 and 9, blank",
  "10 sur 10": "10 of 10",
  "10 sur 10 joker": "10 of 10, blank",
  "11 sur 11": "11 of 11",
  "11 sur 11 joker": "11 of 11, blank",
  "12 sur 12": "12 of 12",
  "12 sur 12 joker": "12 of 12, blank",
  "13 sur 13": "13 of 13",
  "13 sur 13 joker": "13 of 13, blank",
  "14 sur 14": "14 of 14",
  "14 sur 14 joker": "14 of 14, blank",
  "15 sur 15": "15 of 15",
  "15 sur 15 joker": "15 of 15, blank",
  ...
  "La plus chère": "Highest scoring",
  "La moins chère": "Lowest scoring",
  "La plus courte": "Fewest moves",
  "La plus longue": "Most moves",
  "Le plus de farfouilles": "Most farfouilles",
  "Le moins de farfouilles": "Fewest farfouilles",
  "Le coup le plus cher": "Highest scoring move",
  "Le coup le moins cher": "Lowest scoring move",
  "Les plus ratés": "Most missed",
  "Les plus trouvés": "Most found",

  "Temps / coup": "Time / move",
  "Chrono": "Clock",
  "Coups": "Moves",
  "Farfouilles": "Farfouilles",
  "Date": "Date",
  "Lexique": "Lexicon",
  "Mot": "Word",
  "Points": "Points",
  "Trouvé par": "Found by",
  "Sorti en top": "Came up as top",
  "Raté": "Missed",
  ...
  "Empreinte du lexique : {e}": "Lexicon fingerprint: {e}",
  "Le rejeu d'une partie archivée reste à construire":
    "Replaying an archived game is not built yet",
  "Aucune partie enregistrée dans cette catégorie.": "No game recorded in this category.",
  "Aucune partie topée dans cette catégorie.": "No fully topped game in this category.",
  "Aucun coup enregistré dans cette catégorie.": "No move recorded in this category.",
  "Aucun mot compté pour l'instant.": "No word counted yet.",
  "serveur injoignable": "server unreachable",
  "Catégories principales": "Main categories",
  "Catégories annexes": "Side categories",
  "Règles": "Rules",
  "Moindre": "Small",
  "Supérieur": "Large",
  "Chrono le plus court": "Shortest clock",
  "WU et QI": "WU and QI",
  "2 sur 2": "2 of 2",
  "2 sur 2 joker": "2 of 2, blank",
  "3 sur 3": "3 of 3",
  "3 sur 3 joker": "3 of 3, blank",
  "4 sur 4": "4 of 4",
  "4 sur 4 joker": "4 of 4, blank",
  "5 sur 5": "5 of 5",
  "5 sur 5 joker": "5 of 5, blank",
  "6 sur 6": "6 of 6",
  ...
  // Le compétitif (SPEC.md §29).
  "Compétitif": "Competitive",
  "Parties du jour": "Daily games",
  "← Parties du jour": "← Daily games",
  "Partie du jour": "Daily game",
  "Tournois": "Tournaments",
  "Aucun tournoi pour l'instant.": "No tournament yet.",
  "Calendrier": "Calendar",
  "Résultats": "Results",
  "Reprendre": "Resume",
  "Pause": "Pause",
  "Lancer": "Start",
  "Jouer seul": "Play alone",
  "(Entrée)": "(Enter)",
  "À plusieurs sur ce compte": "Several on this account",
  "Noms des joueurs": "Players' names",
  "Jouer en équipe": "Play as a team",
  "{nom} lance la partie.": "{nom} starts the game.",
  "super grille": "super grid",
  "Les parties du jour se préparent.": "The daily games are being prepared.",
  "Les parties du jour se préparent, réessayez dans un instant":
    "The daily games are being prepared, try again in a moment",
  "Les parties du jour se jouent avec un compte": "Daily games are played with an account",
  "Vous avez déjà joué cette partie": "You have already played this game",
  "Cette partie se joue sans vous": "This game is being played without you",
  ...
  "Personne n'a encore joué cette partie.": "Nobody has played this game yet.",
  "Personne n'a encore joué ces parties.": "Nobody has played these games yet.",
  "(à plusieurs)": "(several)",
  "{n} partie": "{n} game",
  "{n} parties": "{n} games",
  "Vos parties": "Your games",
  "Vous n'avez pas encore joué ces parties.": "You have not played these games yet.",
  "en cours": "in progress",
  "Total : {temps} · {neg} · {score} points": "Total: {temps} · {neg} · {score} points",
  "Feuille de route de {nom}": "Score sheet of {nom}",
  "La feuille de route s'affiche une fois la partie jouée.": "The score sheet shows once you have played the game.",
  "La feuille de route s'affiche une fois la partie finie.": "The score sheet shows once you have finished the game.",
  "{n} joueur": "{n} player",
  "Choisissez une ligne du classement.": "Pick a line of the ranking.",
  "Mot retenu": "Retained word",
  "Votre mot": "Your word",
  "Mot de {nom}": "Word of {nom}",
  ...
  "Nég.": "Gap",
  "/{n} joueurs": "/{n} players",
  "SOLO de {nom}": "SOLO by {nom}",
  "{a}, {b} et {n} autres": "{a}, {b} and {n} others",
  "Temps moyen par coup": "Average time per move",
  "Tops trouvés": "Tops found",
  "Farfouilles trouvées": "Bingos found",
  "Cumul des meilleurs temps": "Sum of best times",
  "Trouvé par {n}": "Found by {n}",
  "Les autres solutions": "Other solutions",
  "Sans solution": "No solution",
  "points": "points",
  "La course": "The race",
  "Difficulté des coups": "Move difficulty",
  "Rang au fil des coups": "Rank move by move",
  "Répartition des temps": "Time distribution",
  "raté": "missed",
  "coup raté": "missed move",
  "médiane": "median",
  "moyenne": "mean",
  "meilleur temps": "best time",
  "les autres joueurs": "other players",
  "{nom}, écart au cumul médian": "{nom}, gap to the median total",
  "coups trouvés par {nom}": "moves found by {nom}",
  "coups ratés par {nom}": "moves missed by {nom}",
  "{nom}, et les dix premiers au temps cumulé": "{nom}, and the top ten by total time",
  "{nom} : plus rapide que {p} % des joueurs": "{nom}: faster than {p}% of players",
  "{n} joueurs, au temps total": "{n} players, by total time",
  "{a} à {b} : {n}": "{a} to {b}: {n}",
};
